...
var templateObject_1$h, templateObject_2$8, templateObject_3$5, templateObject_4$1, templateObject_5$1;
...
var StyledAvatar = styled__default['default'].div(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 0px;\n  }\n"], ["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 0px;\n  }\n"])));
var Pip = styled__default['default'].div(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 0px;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"], ["\n  background-color: ", ";\n  border-radius: 0px;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.failure;
});
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default['default'].createElement(Icon$6, { width: "32px", height: "32px" }));
    if (isExternal) {
...
var Container$1 = styled__default['default'].div(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  display: block;\n  flex-direction: column;\n  width: 100%;\n"], ["\n  display: block;\n  flex-direction: column;\n  width: 100%;\n"])));
var Connect = styled__default['default'].div(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  ", ";\n  margin-top: 8px;\n"], ["\n  ", ";\n  margin-top: 8px;\n"])), function (_a) {
    var isMobile = _a.isMobile;
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$1, null,
        React__default['default'].createElement(Connect, { isMobile: isMobile },
        ...
        links.map(function (entry) {
            ...
            if (entry.items) {
                return (React__default['default'].createElement("div", null, entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick, isMobile: isMobile },
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang, isMobile = _a.isMobile;
    if (!isPushed) {
    ...
    return (React__default['default'].createElement(Container, { isMobile: isMobile },
        React__default['default'].createElement(SocialEntry, { isMobile: isMobile },
...
var StyledPanel = styled__default['default'].div(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  position: fixed;\n  ", "\n\n  top: 0;\n  left: 0;\n  height: ", ";\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n\n  ", "\n\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n  }\n"], ["\n  position: fixed;\n  ", "\n\n  top: 0;\n  left: 0;\n  height: ", ";\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n\n  ", "\n\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n  }\n"])), function (_a) {
    ...
    return (isMobile ? "width: " + (isPushed ? SIDEBAR_WIDTH_FULL + "px" : 0) + ";" : "width:100%;");
}, function (_a) {
...
var StyledNav = styled__default['default'].nav(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: fixed;\n  ", "\n  display: ", ";\n  left: 0;\n  transition: top 0.2s;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n\n  height: ", "px;\n\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  ", "\n  display: ", ";\n  left: 0;\n  transition: top 0.2s;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n\n  height: ", "px;\n\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    ...
    var isMobile = _a.isMobile;
    return (isMobile ? "flex" : "none");
}, function (_a) {
    var isMobile = _a.isMobile;
    return (isMobile ? "" + MENU_HEIGHT : "0");
}, function (_a) {
    var theme = _a.theme;
    return theme.nav.background;
});
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, login: login, logout: logout, account: account, profile: profile }),
